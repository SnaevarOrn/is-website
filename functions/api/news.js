...
mbl: {
  ...
  url: [
    ...
    aknet:          { url: "https://www.akureyri.net/feed",     label: "Akureyri.net" },
    akis:           { url: "https://www.akureyri.is/feed.xml",  label: "Akureyri.is" },
    ...
    hi:             { url: "https://hi.is/frettir/18556/feed",  label: "Háskóli Íslands" },
    ...
    skagafjordur:   { url: "https://www.skagafjordur.is/feed",  label: "Skagafjörður" },
